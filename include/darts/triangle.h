...
public:
    ...
    Vec3f vertex_position(size_t i) const { return m_mesh->v[m_mesh->vi[m_face_idx][i]]; }
    ...
    const shared_ptr<const Mesh> mesh() const { return m_mesh; }

    uint32_t face_index() const { return m_face_idx; }
