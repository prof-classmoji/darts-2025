...
template <class T>
using Mat23 = la::mat<T, 2, 3>;
template <class T>
using Mat24 = la::mat<T, 2, 4>;
template <class T>
using Mat32 = la::mat<T, 3, 2>;
template <class T>
using Mat33 = la::mat<T, 3, 3>;
template <class T>
using Mat34 = la::mat<T, 3, 4>;
template <class T>
using Mat42 = la::mat<T, 4, 2>;
template <class T>
using Mat43 = la::mat<T, 4, 3>;
template <class T>
...
inline float luminance(const Color3f &c) { return dot(c, {0.212671f, 0.715160f, 0.072169f}); }

inline float luminance(const Color4f &c) { return luminance(c.xyz()); }
