...
public:
    ...
    int index_1d(int x, int y) const { return y * m_size.x + x; }

    /// Convert the 1d index into a 2d index
    std::pair<int, int> index_2d(int i) const { return std::make_pair(i % m_size.x, i / m_size.x); }
