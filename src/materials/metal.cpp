...
bool Metal::scatter(const Ray3f &ray, const HitRecord &hit, Color3f &attenuation, Ray3f &scattered) const
{
    // TODO: Implement metal reflection
    //       This function proceeds similar to the diffuse material, except that the
